  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
          ...
          padding: EdgeInsets.only(left: defaultPadding, right: defaultPadding*0.4),
                  ...
                  Positioned(
                    ...
                    child: ClipRRect(
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          padding: EdgeInsets.only(left: defaultPadding* 0.5, right: defaultPadding * 0.5, top: defaultPadding * 0.2, bottom: defaultPadding * 0.2),
                          child: Text(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                              ...
                              child: IconButton(
                                onPressed: () {},
                                icon: Icon(Icons.bookmark_border_rounded, color: Colors.white, size: 18),
                              )
                          ),
